...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        fetch('https://www.pick6.club/api/getResults')
...
function handleCreatePoolSubmit(e) {
    ...
    try {
      ...
      // Send the API request
      fetch('https://www.pick6.club/pools/create', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  function setupJoinPoolForm() {
    ...
    newForm.addEventListener('submit', function(e) {
      ...
      // Send the API request
      fetch('https://www.pick6.club/pools/joinByName', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  function updateCurrentWeekDisplay() {
    ...
    fetch('https://www.pick6.club/getCurrentWeek')
      .then(response => response.json())
      .then(data => {
...
async function saveInitialTimes() {
    try {
        await fetch('https://www.pick6.club/api/timewindows', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
/*function updateNavUsername() {
  ...
  function updateCountdown() {
    ...
    fetch('https://www.pick6.club/api/timewindows')
        .then(response => response.json())
        .then(data => {
            const now = new Date();
...
if (profileIconCenter) {
    ...
    document.getElementById('profilePic').addEventListener('change', async (event) => {
        ...
        if (file) {
            ...
            try {
                const response = await fetch('https://www.pick6.club/api/uploadProfilePicture', {
                    method: 'POST',
                    body: formData,
                });
...
async function loadUserBio() {
    const username = localStorage.getItem('username').toLowerCase();
    const response = await fetch(`https://www.pick6.club/api/getUserBio/${username}`);
    const userData = await response.json();
...
async function saveUserBio(bio) {
    const username = localStorage.getItem('username').toLowerCase();
    const response = await fetch(`https://www.pick6.club/api/saveUserBio`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function showInPoolUserProfile(username) {
    ...
    try {
        // Get user data
        const response = await fetch(`https://www.pick6.club/api/getUserProfile/${username.toLowerCase()}`);
        const userData = await response.json();
        
        // Get bio data
        const bioResponse = await fetch(`https://www.pick6.club/api/getUserBio/${username.toLowerCase()}`);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function checkForSurvivorPools() {
        try {
            ...
            const response = await fetch(`https://www.pick6.club/pools/userPools/${encodeURIComponent(username.toLowerCase())}`);
...
joinPoolForm.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('https://www.pick6.club/pools/joinByName', {
            method: 'POST',
...
function sortPlayersByPoints(players) {
  ...
  function fetchUserProfile(username) {
    ...
    return fetch(`https://www.pick6.club/api/getUserProfile/${encodedUsername}`)
        .then(response => response.json())
        .then(userProfile => {
            if (!userProfile) {
...
async function movePool(poolName, direction) {
    ...
    try {
        ...
        const response = await fetch('https://www.pick6.club/pools/reorder', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function fetchMessages(poolName, chatBox) {
    ...
    fetch(`https://www.pick6.club/pools/getChatMessages${queryParam}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function sendMessage(username, poolName, message, chatBox) {
    ...
    fetch('https://www.pick6.club/pools/sendChatMessage', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function savePicksToLastWeek() {
    try {
        ...
        const response = await fetch('https://www.pick6.club/api/savePicksToLastWeek', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchPicksData(username, poolName) {
    ...
    const url = `https://www.pick6.club/api/getPicks/${encodedUsername}/${encodedPoolName}`;
...
function deletePool(poolName) {
    ...
    fetch(`https://www.pick6.club/pools/delete/${encodedPoolName}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
...
function leavePool(poolName) {
    ...
    fetch(`https://www.pick6.club/pools/leave/${encodedUsername}/${encodedPoolName}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
   ...
   toggleJoinFormButton.addEventListener('click', function() {
    ...
    joinPoolForm.addEventListener('submit', function(event) {
       ...
       // //console.log('Attempting to join pool with the following details:', joinPayload);
        ...
        const apiEndpoint = 'https://www.pick6.club/pools/joinByName'; // This should match your server route
...
function updateUserPoints(username, additionalPoints, poolName) {
    fetch('https://www.pick6.club/pools/updateUserPointsInPoolByName', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
function changeUserPoints(username, points, poolName) {
    fetch('https://www.pick6.club/pools/setUserPointsInPoolByName', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
function updateUserStats(username, poolName, winIncrement = 0, lossIncrement = 0, pushIncrement = 0) {
    fetch('https://www.pick6.club/pools/updateUserStatsInPoolByName', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
function resetUserStats(username, poolName) {
    fetch('https://www.pick6.club/pools/resetUserStatsInPoolByName', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function fetchSurvivorStatus(username, poolName) {
    try {
        ...
        const response = await fetch(`https://www.pick6.club/pools/getSurvivorStatus/${encodedUsername}/${encodedPoolName}`);
...
async function fetchEliminationInfo(username, poolName) {
    try {
        ...
        const response = await fetch(`https://www.pick6.club/pools/getEliminationInfo/${encodedUsername}/${encodedPoolName}`);
    ...
    try {
        ...
        const membersData = await Promise.all(pool.members.map(async member => {
            try {
                ...
                const statusResponse = await fetch(`https://www.pick6.club/pools/getSurvivorStatus/${encodeURIComponent(lowercaseUsername)}/${encodeURIComponent(pool.name)}`);
...
async function fetchPlayoffBracket(poolName) {
    ...
    try {
        const encodedPoolName = encodeURIComponent(poolName);
        const url = `https://www.pick6.club/api/playoffs/${encodedPoolName}/bracket`;
...
async function submitPlayoffPicks(picks, poolName) {
    ...
    try {
        const response = await fetch(`https://www.pick6.club/api/playoffs/${poolName}/picks`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'x-username': username
...
//neeehehehehe
  ...
  function debugPlayoffBracket(poolName) {
    fetch(`https://www.pick6.club/api/playoffs/${encodeURIComponent(poolName)}/bracket`)
      .then(response => response.json())
      .then(data => {
        if (data.success && data.bracket) {
...
function createMatchHistoryElement(match) {
  ...
  async function fetchPlayoffBracket(poolName) {
    try {
      const response = await fetch(`https://www.pick6.club/api/playoffs/${encodeURIComponent(poolName)}/bracket`);
      if (!response.ok) {
        throw new Error(`Failed to fetch bracket data: ${response.status}`);
      }
...
async function showPlayerPicks(player, poolName) {
    ...
    try {
        const weekResponse = await fetch(`https://www.pick6.club/api/playoffs/isPlayoff/${poolName}`);
        if (weekResponse.ok) {
            const weekData = await weekResponse.json();
            if (weekData.success) {
    ...
    try {
        ...
        try {
            const bracketResponse = await fetch(`https://www.pick6.club/api/playoffs/${poolName}/bracket`);
        ...
        let results = [];
        try {
            const resultsResponse = await fetch('https://www.pick6.club/api/getResults');
...
async function fetchPlayoffPicks(username, poolName) {
    try {
        ...
        // Use the correct endpoint from your server-side routes
        const url = `https://www.pick6.club/api/playoffs/${encodedPoolName}/picks/${encodedUsername}`;
...
function addSurvivorPoolLockControl(poolWrapper, isAdmin, poolName, isLocked) {
    ...
    checkbox.addEventListener('change', async (event) => {
      ...
      try {
        ...
        const response = await fetch('https://www.pick6.club/pools/toggleSurvivorLock', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
function startGolfDraft(poolName) {
  if (confirm(`Are you sure you want to start the draft for "${poolName}"? This cannot be undone.`)) {
    fetch(`https://www.pick6.club/api/startGolfDraft/${encodeURIComponent(poolName)}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function fetchGolfPicks(username, poolName) {
  try {
    ...
    const response = await fetch(`https://www.pick6.club/api/golfPicks/${encodedUsername}/${encodedPoolName}`);
...
async function fetchGolfDraftState(poolName) {
  try {
      const response = await fetch(`https://www.pick6.club/api/getDraftState/${encodeURIComponent(poolName)}`);
      if (!response.ok) {
...
async function fetchGolfScores(poolName) {
  try {
    const response = await fetch(`https://www.pick6.club/api/getGolfScores/${encodeURIComponent(poolName)}`);
  ...
  fetchUserProfile(member.username.toLowerCase())
    .then(userProfile => {
      if (userProfile && userProfile.profilePicture) {
       profilePic.style.backgroundImage = `url('https://www.pick6.club/${userProfile.profilePicture}')`;
      }
    })
    .catch(err => {
...
// Add this function to determine the score class based on tier system
function getGolfScoreClass(score) {
  if (score < 0) {
    return 'score-under'; // Green for under par
  } else if (score === 0) {
    return 'score-even'; // Yellow/white for even par
  } else if (score >= 1 && score <= 9) {
    return 'score-over-light'; // Light red for +1 to +9
  } else if (score >= 10 && score <= 19) {
    return 'score-over-medium'; // Medium red for +10 to +19
  } else if (score >= 20) {
    return 'score-over-dark'; // Dark red for +20 and over
  }
  return 'score-over-light'; // Default to light red
}

// Updated createGolfPlayerRow function with CUT handling and score tiers
async function createGolfPlayerRow(member, currentUsername, pool, phase, golfDraftState = null) {
  const playerRow = document.createElement("div");
  playerRow.className = "golf-player-row";
          ...
          if (golfPicksData.success && golfPicksData.picks && golfPicksData.picks.length > 0) {
              ...
              golfPicksData.picks.forEach(pick => {
                  ...
                  if (phase === "Draft") {
                      ...
                      const scoreDisplay = typeof pick.score !== 'number' ? 'E' : 
                                         (score === 0 ? 'E' : (score > 0 ? `+${score}` : score));
                      const scoreClass = typeof pick.score !== 'number' ? 'score-tbd' : getGolfScoreClass(score);
              ...
              if (phase === "Tournament" && validScoresCount > 0) {
                  ...
                  const formattedScore = finalTotalScore === 0 ? 'E' : 
                                       (finalTotalScore > 0 ? `+${finalTotalScore}` : finalTotalScore);
                  const scoreClass = getGolfScoreClass(finalTotalScore);
                  sumSection.innerHTML = `<span class="${scoreClass}">${formattedScore}</span>`;
              } else if (phase === "Tournament") {
                  sumSection.textContent = "-"; // Show dash if no valid scores yet
              } else if (phase === "Draft") {
  ...
  golfScores.forEach(userScore => {
    ...
    if (picksSection) {
      ...
      sortedGolfers.forEach(golfer => {
        ...
        const scoreClass = getGolfScoreClass(score);
    ...
    if (sumSection) {
      ...
      const scoreClass = getGolfScoreClass(totalScore);
